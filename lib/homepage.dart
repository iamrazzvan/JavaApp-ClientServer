...
import 'api/races_api.dart';
import 'models/race.dart';
import 'websocket_service.dart'; // WebSocket integration
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    WebSocketService().onMessageReceived = (String action, int id) {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                controller: _nameController,
                decoration: const InputDecoration(hintText: 'Race name...'),
              ),
              TextField(
                controller: _capacityController,
