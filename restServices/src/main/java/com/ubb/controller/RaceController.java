...
import com.ubb.websocket.NotificationHandler;
...
public class RaceController {
    ...
    public Race create(@RequestBody Race race) {
        ...
        // Notificare WebSocket pentru creare
        NotificationHandler.broadcast("{\"action\":\"create\",\"id\":" + added.get().getId() + "}");
    ...
    public ResponseEntity<?> update(@PathVariable String id, @RequestBody Race race) {
        ...
        // Notificare WebSocket pentru actualizare
        NotificationHandler.broadcast("{\"action\":\"update\",\"id\":" + id + "}");
    ...
    public ResponseEntity<?> delete(@PathVariable String id) {
        ...
        // Notificare WebSocket pentru ștergere
        NotificationHandler.broadcast("{\"action\":\"delete\",\"id\":" + id + "}");
